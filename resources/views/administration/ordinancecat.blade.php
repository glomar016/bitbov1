...
@section('page-js')
    ...
    <script>
        ...
        $("#table_ordinance_list").DataTable({
            "bSort" : false
        });
        });
 ...
 {{--    <script type="text/javascript">
    ...
    <script type="text/javascript">
        $('#table_ordinance_list').on('click', '#viewCategorybtn',function (){
   ...
   {{--  <script type="text/javascript">
     ...
     <script type="text/javascript">
        $('#table_ordinance_list').on('click', '#editmodalBtn',function (){
        let row = $(this).closest("tr")
       $("#EditCatID").val($(this).closest("tbody tr").find("td:eq(0)").html());
        $("#EditCatName").val($(this).closest("tbody tr").find("td:eq(1)").html());
            ...
            <div>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <br>
                        <br>
                        <table id="table_ordinance_list" class="table table-striped table-bordered">
                            <thead>
                            <tr>
                                ...
                                @foreach($displaydata as $value)
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <button type='button' id="viewCategorybtn" class='btn btn-warning 'data-toggle='modal' data-target='#ViewModal' >
                                                <i class='fa fa-eye'></i> View
                                            </button>

                                            <button type='button' id="editmodalBtn" class='btn btn-success ' data-toggle='modal' data-target='#UpdateModal'>
