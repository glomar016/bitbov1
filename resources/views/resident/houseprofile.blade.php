...
<script type="text/javascript">
    var table = $("#data-table-default").DataTable({
        ...
        columns: [{
            ...
            {
                data: "PERSON_STAYING_IN_HOUSEHOLD",
                name: "PERSON_STAYING_IN_HOUSEHOLD"
            },
            {
                data: "HOME_MATERIALS",
                name: "HI.HOME_MATERIALS",
                searchable: false
            },
            ...
            {
                data: "WATER_UTILITIES",
                name: "WATER_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "ELECTRICITY_UTILITIES",
                name: "ELECTRICITY_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "AIRCON_UTILITIES",
                name: "AIRCON_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "PHONE_UTILITIES",
                name: "PHONE_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "COMPUTER_UTILITIES",
                name: "COMPUTER_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "INTERNET_UTILITIES",
                name: "INTERNET_UTILITIES",
                visible: false,
                searchable: false
            },
            {
            ...
            {
                data: "CD_PLAYER_UTILITIES",
                name: "CD_PLAYER_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "RADIO_UTILITIES",
                name: "RADIO_UTILITIES",
                visible: false,
                searchable: false
            },
            {
                data: "COMICS_ENTERTAINMENT",
                name: "COMICS_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "NEWS_PAPER_ENTERTAINMENT",
                name: "NEWS_PAPER_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "PETS_ENTERTAINMENT",
                name: "PETS_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "BOOKS_ENTERTAINMENT",
                name: "BOOKS_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "STORY_BOOKS_ENTERTAINMENT",
                name: "STORY_BOOKS_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "TOYS_ENTERTAINMENT",
                name: "TOYS_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "BOARD_GAMES_ENTERTAINMENT",
                name: "BOARD_GAMES_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
                data: "PUZZLES_ENTERTAINMENT",
                name: "PUZZLES_ENTERTAINMENT",
                visible: false,
                searchable: false
            },
            {
            ...
            {
                data: "FAMILY_HEADER_ID",
                name: "FAMILY_HEADER_ID",
                visible: false,
                searchable: false
            },
...
<script type="text/javascript">
    function famMembers(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                enc_id = data;
                location.href = "{{asset('')}}" + "HouseholdMembers/" + enc_id;
            }
        });
    ...
    $(document).ready(function() {
        ...
        $('#data-table-default tbody').on('click', 'tr', function() {
            ...
            if (edittoilet == 1) {
                document.getElementById('edittoilet').checked = true;
            } else if (edittoilet == 0) {
                document.getElementById('edittoilet').checked = false;
            }
            if (parea == 1) {
                document.getElementById('editplayarea').checked = true;
            } else if (parea == 0) {
                document.getElementById('editplayarea').checked = false;
            }
            if (bedroom == 1) {
                document.getElementById('editbedroom').checked = true;
            } else if (bedroom == 0) {
                document.getElementById('editbedroom').checked = false;
            }
            if (dining == 1) {
                document.getElementById('editdining').checked = true;
            } else if (dining == 0) {
                document.getElementById('editdining').checked = false;
            }
            if (sala == 1) {
                document.getElementById('editsala').checked = true;
            } else if (sala == 0) {
                document.getElementById('editsala').checked = false;
            }
            if (kitchen == 1) {
                document.getElementById('editkitchen').checked = true;
            } else if (kitchen == 0) {
                document.getElementById('editkitchen').checked = false;
            }
            if (water == 1) {
                document.getElementById('editrunningwater').checked = true;
            } else if (water == 0) {
                document.getElementById('editrunningwater').checked = false;
            }
            if (electric == 1) {
                document.getElementById('editelectricity').checked = true;
            } else if (electric == 0) {
                document.getElementById('editelectricity').checked = false;
            }
            if (aircon == 1) {
                document.getElementById('editaircon').checked = true;
            } else if (aircon == 0) {
                document.getElementById('editaircon').checked = false;
            }
            if (phone == 1) {
                document.getElementById('editmobile').checked = true;
            } else if (phone == 0) {
                document.getElementById('editmobile').checked = false;
            }
            if (computer == 1) {
                document.getElementById('editcomputer').checked = true;
            } else if (computer == 0) {
                document.getElementById('editcomputer').checked = false;
            }
            if (internet == 1) {
                document.getElementById('editinternet').checked = true;
            } else if (internet == 0) {
                document.getElementById('editinternet').checked = false;
            }
            if (tv == 1) {
                document.getElementById('edittv').checked = true;
            } else if (tv == 0) {
                document.getElementById('edittv').checked = false;
            }
            if (cdplayer == 1) {
                document.getElementById('editdvd').checked = true;
            } else if (cdplayer == 0) {
                document.getElementById('editdvd').checked = false;
            }
            if (radio == 1) {
                document.getElementById('editradio').checked = true;
            } else if (radio == 0) {
                document.getElementById('editradio').checked = false;
            }
            if (comics == 1) {
                document.getElementById('editcomics').checked = true;
            } else if (comics == 0) {
                document.getElementById('editcomics').checked = false;
            }
            if (newspaper == 1) {
                document.getElementById('editnews').checked = true;
            } else if (newspaper == 0) {
                document.getElementById('editnews').checked = false;
            }
            if (pets == 1) {
                document.getElementById('editpets').checked = true;
            } else if (pets == 0) {
                document.getElementById('editpets').checked = false;
            }
            if (books == 1) {
                document.getElementById('editbooks').checked = true;
            } else if (books == 0) {
                document.getElementById('editbooks').checked = false;
            }
            if (storybooks == 1) {
                document.getElementById('editsbooks').checked = true;
            } else if (storybooks == 0) {
                document.getElementById('editsbooks').checked = false;
            }
            if (toys == 1) {
                document.getElementById('edittoys').checked = true;
            } else if (toys == 0) {
                document.getElementById('edittoys').checked = false;
            }
            if (bgames == 1) {
                document.getElementById('editbgames').checked = true;
            } else if (bgames == 0) {
                document.getElementById('editbgames').checked = false;
            }
            if (puzzle == 1) {
                document.getElementById('editpuzzles').checked = true;
            } else if (puzzle == 0) {
                document.getElementById('editpuzzles').checked = false;
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#EditBTN').on('click', function() {
            ...
            if ($("#edittoilet").is(":checked")) {
                var toilet = 1;
            } else if ($("#edittoilet").is(":not(:checked)")) {
                var toilet = 0;
            }

            if ($("#editplayarea").is(":checked")) {
                var playarea = 1;
            } else if ($("#editplayarea").is(":not(:checked)")) {
                var playarea = 0;
            }

            if ($("#editbedroom").is(":checked")) {
                var bedroom = 1;
            } else if ($("#editbedroom").is(":not(:checked)")) {
                var bedroom = 0;
            }

            if ($("#editdining").is(":checked")) {
                var dining = 1;
            } else if ($("#editdining").is(":not(:checked)")) {
                var dining = 0;
            }

            if ($("#editsala").is(":checked")) {
                var sala = 1;
            } else if ($("#editsala").is(":not(:checked)")) {
                var sala = 0;
            }

            if ($("#editkitchen").is(":checked")) {
                var kitchen = 1;
            } else if ($("#editkitchen").is(":not(:checked)")) {
                var kitchen = 0;
            }



            if ($("#editrunningwater").is(":checked")) {
                var runningwater = 1;
            } else if ($("#editrunningwater").is(":not(:checked)")) {
                var runningwater = 0;
            }

            if ($("#editelectricity").is(":checked")) {
                var electricity = 1;
            } else if ($("#editelectricity").is(":not(:checked)")) {
                var electricity = 0;
            }

            if ($("#editaircon").is(":checked")) {
                var aircon = 1;
            } else if ($("#editaircon").is(":not(:checked)")) {
                var aircon = 0;
            }



            if ($("#editmobile").is(":checked")) {
                var mobile = 1;
            } else if ($("#editmobile").is(":not(:checked)")) {
                var mobile = 0;
            }

            if ($("#editcomputer").is(":checked")) {
                var ncomputer = 1;
            } else if ($("#editcomputer").is(":not(:checked)")) {
                var ncomputer = 0;
            }

            if ($("#editinternet").is(":checked")) {
                var internet = 1;
            } else if ($("#editinternet").is(":not(:checked)")) {
                var internet = 0;
            }

            if ($("#edittv").is(":checked")) {
                var boxtv = 1;
            } else if ($("#edittv").is(":not(:checked)")) {
                var boxtv = 0;
            }

            if ($("#editdvd").is(":checked")) {
                var cdplayer = 1;
            } else if ($("#editdvd").is(":not(:checked)")) {
                var cdplayer = 0;
            }

            if ($("#editradio").is(":checked")) {
                var boxradio = 1;
            } else if ($("#editradio").is(":not(:checked)")) {
                var boxradio = 0;
            }

            if ($("#editcomics").is(":checked")) {
                var ncomics = 1;
            } else if ($("#editcomics").is(":not(:checked)")) {
                var ncomics = 0;
            }

            if ($("#editnews").is(":checked")) {
                var newspaper = 1;
            } else if ($("#editnews").is(":not(:checked)")) {
                var newspaper = 0;
            }

            if ($("#editpets").is(":checked")) {
                var pets = 1;
            } else if ($("#editpets").is(":not(:checked)")) {
                var pets = 0;
            }

            if ($("#editbooks").is(":checked")) {
                var books = 1;
            } else if ($("#editbooks").is(":not(:checked)")) {
                var books = 0;
            }

            if ($("#editsbooks").is(":checked")) {
                var storybooks = 1;
            } else if ($("#editsbooks").is(":not(:checked)")) {
                var storybooks = 0;
            }

            if ($("#edittoys").is(":checked")) {
                var toys = 1;
            } else if ($("#edittoys").is(":not(:checked)")) {
                var toys = 0;
            }

            if ($("#editbgames").is(":checked")) {
                var boardgames = 1;
            } else if ($("#editbgames").is(":not(:checked)")) {
                var boardgames = 0;
            }

            if ($("#editpuzzles").is(":checked")) {
                var puzzles = 1;
            } else if ($("#editpuzzles").is(":not(:checked)")) {
                var puzzles = 0;
            }
        ...
        <div>
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <br>
                    <div id="loadtable">
                        <table id="data-table-default" class="table table-striped table-bordered display compact" 
