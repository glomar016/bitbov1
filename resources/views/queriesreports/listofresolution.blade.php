 ...
 function loadfilter(fd) {
    return new Promise((resolve,reject) => {
        ...
        setTimeout(() => {
            ...
            var  FULLNAME, ORDINANCE_AUTHOR, ORDINANCE_TITLE, ORDINANCE_CATEGORY_NAME, ORDINANCE_SANCTION ,ORDINANCE_DESCRIPTION;
            ACTIVE_FLAG = 1;
            $.ajax({
                url:"{{route('ListofResolutionFilter')}}",
                type:'post',
                processData:false,
                contentType:false,
                ...
                success:function(data)
                {
                    ...
                    data.map( value => { 
                        ...
                        ORDINANCE_DESCRIPTION = value.ORDINANCE_DESCRIPTION 
                        // $(".tablecell").each(function() {
                        //     // get text into variable
                        //     // var colText = $(this).text();
                        //     // need to create an action
...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">List of Resolution</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">List of Resolution<br><small>You can filter resolution reports.</small></h1>
    <!-- end page-header -->

    <!-- begin row -->
    <div >
        <form method="POST" action="{{route('ListofResolutionPrint')}}" >
            {{ csrf_field() }}
            <div class="row">
                                                ...
                                                <tbody>
                                                   @foreach($ordinances as $record)
                                                     <tr >
                                                        ...
                                                        <td >{{ $record->ORDINANCE_DESCRIPTION }}</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
