                    ...
                    $.ajax({
                        ...
                        success:function(response)
                        {
                           ...
                           $.each(response["result"], function(){
                            ...
                            // time = split[1];
                            const datentime = new Date(datetime);
                            hours = datentime.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' });

                             table.append('<tr id="'+this["patawag_id"]+'"> <td hidden>'+this["patawag_id"]+'</td> <td>'+split[0]+'</td> <td>'+hours+'</td> <td>'+this["patawag_sched_place"]+"</td> </tr>");
