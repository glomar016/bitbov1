...
<head>
  ...
  <div align="center">
    <figure>
      ...
      <figcaption>List of Resolution Generated By The System.</figcaption>
    </figure>
...
<body style="background: white">
  ...
  <div class="panel-body">
    ...
    <table style="font-size: 15px; width: 100%;" border="1" cellpadding="5">
      <thead>
        <tr>
          <th style="text-align: center;">Resolution Number</th>
          <th style="text-align: center">Title</th>
          <th style="text-align: center">Primary Author</th>
          <th style="text-align: center">Secondary Author</th>
      ...
      <tbody>
        ...
        <tr>
           <td style="border:1px solid; text-align: center;">{{$row->ORDINANCE_NUMBER}}</td>
          ...
          <td style="border:1px solid; text-align: center;">{{$row->ORDINANCE_AUTHOR}}</td>
           <td style="border:1px solid; text-align: center;">{{$row->ORDINANCE_DESCRIPTION}}</td>
          <td style="border:1px solid; text-align: center;">{{$row->ORDINANCE_CATEGORY_NAME}}</td>
          <td style="border:1px solid; text-align: center;">{{$row->EFFECTIVITY_DATE}}</td> 
        </tr>
