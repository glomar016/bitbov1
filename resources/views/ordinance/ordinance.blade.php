...
<script type="text/javascript">
    ...
    .then((willDelete) => {
        if (willDelete)
        {
            window.location.href = "{{route('OrdinanceExport')}}";
        }
        else
        {
        ...
        <div class="tab-pane fade active show" >
             ...
             <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">List Of Ordinance</h4>
                </div>
                <!-- end panel-heading -->
                <div class="alert alert-yellow fade show">
                    ...
                    The following are the existing records of ordinance in the barangay.
                            ...
                            <button type='button' class='btn btn-lime ' id="btnExport"  >
                                <i class='fa fa-redo'></i> Export</button>
                           <br>
                            <br><br>
                    <div id="LoadTable">
                                        ...
                                        <div class="modal-body">
                                         ...
                                         <div class="row">
                                                <div class="col-lg-12 col-md-6">
                                                    <div class="stats-content">
                                                     ...
                                                     <input type="text" id="ordi_type" hidden="" name="ordi_type" value=" ORDINANCE" style="display: block; text-align: left; color:black; background-color:white; "  placeholder='' class="form-control" >
                                                 </div>
                                             </div>
                                         </div> <br>
                                         ...
                                         <div class="row">
                                                <div class="col-lg-12 col-md-6" id="ordinance_div">
                                                    <div class="stats-content">
                                                     <label style="display: block; text-align: left">Ordinance Number</label>
                    ...
                    <form id="" method="post">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <br>
                                 <h><label style="display: ">Ordinance Number</label></h>
