   ...
   public function index($typeofview){
    ...
    public function CRUDRequestClearance(Request $request){
        ...
        //Fishery Rental and Privellege
            $G_REGISTERED_NAME = $request->G_REGISTERED_NAME;
            $G_CONSTRUCTION_ADDRESS = $request->G_CONSTRUCTION_ADDRESS;
        //General
        ...
        if($PAPER_TYPE_CLEARANCE == "Barangay Business Permit"){
         ...
         $application_form = DB::Table('t_application_form')
           ...
           $barangay_clearance = DB::table('t_bf_barangay_clearance')
            ...
            $barangay_clearance = DB::table('t_bf_barangay_clearance')
                ->insert(array(
                    'REGISTERED_NAME' => $F_REGISTERED_NAME
                    ,'CONSTRUCTION_ADDRESS' => $F_CONSTRUCTION_ADDRESS
                    ,'F_LICENSE_NO' => $F_LICENSE_NO
                    ,'F_DEVICE_TYPE' => $F_DEVICE_TYPE
                    ,'F_CAPACITY' => $F_CAPACITY
                    ,'F_SERIAL_NO'=> $F_SERIAL_NO
                    ,'APPLICANT_NAME' => $APPLICANT_NAME
                    ,'FORM_ID' => $latest_form_id->FORM_ID
                ));
        ...
        else if($PAPER_TYPE_CLEARANCE == "Barangay Clearance Fishery Rental and Privellege"){
            $application_form = DB::Table('t_application_form')
                ->insert(array(
                    'FORM_NUMBER' => 'XXXX-XXX'
                    ,'PAPER_TYPE_ID' => $form_type_id->PAPER_TYPE_ID
            ...
            $barangay_clearance = DB::table('t_bf_barangay_clearance')
                ->insert(array(
                    'REGISTERED_NAME' => $G_REGISTERED_NAME
                    ,'CONSTRUCTION_ADDRESS' => $G_CONSTRUCTION_ADDRESS
                    ,'APPLICANT_NAME' => $APPLICANT_NAME
                    ,'FORM_ID' => $latest_form_id->FORM_ID
                ));
