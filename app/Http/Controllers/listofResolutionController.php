...
class ListofResolutionController extends Controller
{
    public function index()
    {
        ...
        return view('queriesreports.listofresolution',compact('ordinances','category'));
    }
    ...
    public function getordinances()
    {
        return $ordinances = COLLECT(\DB::SELECT("SELECT O.ORDINANCE_ID, CONCAT(RBI.LASTNAME,' ', RBI.FIRSTNAME, ' ', RBI.MIDDLENAME) AS FULLNAME,
                                            O.ORDINANCE_AUTHOR, O.ORDINANCE_TITLE, OC.ORDINANCE_CATEGORY_NAME, O.ORDINANCE_SANCTION, O.ORDINANCE_REMARKS, O.ACTIVE_FLAG,O.EFFECTIVITY_DATE
                                            ,O.ORDINANCE_NUMBER,O.ORDINANCE_DESCRIPTION
                                            ...
                                            INNER JOIN r_ordinance_category OC ON O.CATEGORY_ID = OC.ORDINANCE_CATEGORY_ID
                                                where ORDINANCE_TYPE ='RESOLUTION'
                                            "));
    }
    ...
    public function filterdisplay()
    {
        ...
        : $response = response()->json($this->getfilter($data));
    ...
    public function filterprint()
    {
        ...
        $view = View('listofresolutionprintable', compact('DisplayTable'));
